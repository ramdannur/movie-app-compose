package id.ramdannur.movieappcompose.core.data.source.local
...
import id.ramdannur.movieappcompose.core.data.source.local.room.FavoriteDao
import id.ramdannur.movieappcompose.core.data.source.local.room.MovieDao
